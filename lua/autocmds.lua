...
a.nvim_create_autocmd("BufWritePost", { pattern = { "bm-files", "bm-dirs" }, group = group,
...
a.nvim_create_autocmd("LspAttach", { group = group,
	callback = function(args)
		...
		bmap("n", "<leader>wl", function() print(vim.inspect(l.buf.list_workspace_folders())) end, { desc = "List workspace folders" })
