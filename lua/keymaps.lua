...
map("v", ">", ">gv")
map("v", "<", "<gv")
map("n", "<C-A-n>", "<cmd>execute 'Lazy! load nnn.nvim' | NnnExplorer %:p:h<CR>")
map("t", "<C-A-n>", "<cmd>NnnExplorer<CR>")
map("n", "<C-A-p>", "<cmd>execute 'Lazy! load nnn.nvim' | NnnPicker %:p:h<CR>")
...
map("n", "<C-A-j>", function() require("trouble").next({ skip_groups = true, jump = true }) end, { desc = "Trouble next item" })
map("n", "<C-A-k>", function() require("trouble").previous({ skip_groups = true, jump = true }) end, { desc = "Trouble previous item" })
...
map("n", "<leader>B", function() require("dap").set_breakpoint(f.input('Breakpoint condition: ')) end, { desc = "DAP Set Conditional Breakpoint" })
map("n", "<leader>lp", function() require("dap").set_breakpoint(nil, nil, f.input('Log point message: ')) end, { desc = "DAP Set Log Point" })
